...
TEMPLATE_GET_ENTITIES = "extended_openai_exposed_entities"
...
class ExtendedOpenAITemplateManager:
    ...
    async def async_setup(self) -> None:
        ...
        def template_environment_init(
            ...
            if hass:
                template_env_self.globals[TEMPLATE_GET_ENTITIES] = _get_exposed_entities
